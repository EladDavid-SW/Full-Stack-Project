...
router.get('/guides', userRoutes.getGuides); // Read all guides
router.get('/guides/:id', userRoutes.getGuide); // Read specific guide
router.post('/tours', userRoutes.createTour); // Create a new tour
router.post('/createGuide', userRoutes.createGuide); // Create a new guide
